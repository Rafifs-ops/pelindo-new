<x-layout>
    <x-frontend.jumbotron>
        <x-slot name="title">{{ __('messages.pedoman_tata_kelola') }}</x-slot>
        <x-slot name="subtitle">Pedoman Good Corporate Governance (GCG) PT Pelindo Multi Terminal</x-slot>
    </x-frontend.jumbotron>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 -mt-16 relative z-20">
        <div class="clay-card p-8 sm:p-12 bg-white relative overflow-hidden border-2 border-white">
            <div class="inline-block mb-3">
                <span class="clay-badge shadow-sm">Tata Kelola Perusahaan</span>
            </div>
            <p class="text-slate-700 mb-8 text-base sm:text-lg leading-relaxed font-normal">
                Pelindo Multi Terminal berkomitmen untuk menerapkan Tata Kelola Perusahaan yang Baik (Good Corporate Governance / GCG) secara konsisten dan berkesinambungan. Berikut adalah daftar buku pedoman tata kelola yang dapat Anda unduh:
            </p>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-gradient-to-r from-[#E8F4FA] to-[#F0F6FA] text-[#0066AE]">
                            ...
                            <th class="py-4 px-6 font-extrabold text-sm uppercase tracking-wider border-b border-slate-200/60">Judul Dokumen Pedoman</th>
