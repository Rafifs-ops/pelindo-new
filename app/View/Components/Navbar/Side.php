    ...
    public function render(): View|Closure|string
    {
        $rawMenus = [
            ...
            [
                ...
                'order' => 4,
                'children' => [
                    ['name_key' => 'messages.program_tjsl', 'route_name' => 'tjsl.index', 'image_url' => 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYSN7vtQ4KRcftJbKUfd6Yj2mpYvUVHRv3kyitxXYBptYy7L4Lsj8SVRKG&s=10', 'subtitle' => null, 'order' => 1],
                ]
            ],
            [
